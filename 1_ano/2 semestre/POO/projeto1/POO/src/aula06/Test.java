...
public class Test {
    ...
    Bolseiro bls = new Bolseiro ("Igor Santos", 8976543, new DateYMD(11, 5, 1985),new DateYMD(19,9,2023), p1,900);
    bls.setBolsa(1050);
    System.out.println("Aluno: " + al.getName());
    System.out.println(al);
    System.out.println("Bolseiro: " + bls.getName() + ", NMec: "
    + bls.getNMec() + ", Bolsa: " + bls.getValor() + ", Orientador: " +
    bls.getProfessor());
    System.out.println(bls);
    }
    }

    //a alguns geters foram mudados os nomes de forma a terem os mesmos nomes aqueles definidos anteriormente 