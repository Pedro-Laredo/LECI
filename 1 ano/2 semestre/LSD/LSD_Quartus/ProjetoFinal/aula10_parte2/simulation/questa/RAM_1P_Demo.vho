...
SIGNAL \RAM|s_memory~102feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~33feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~42feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~43feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~140feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~116feeder_combout\ : std_logic;
...
-- Equation(s):
-- \RAM|s_memory~249_combout\ = (\SW[2]~input_o\ & (!\SW[0]~input_o\ & (\SW[3]~input_o\ & !\SW[1]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~247_combout\ = (\SW[3]~input_o\ & (!\SW[0]~input_o\ & (\SW[1]~input_o\ & \SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~148_combout\ = (\SW[1]~input_o\ & ((\SW[0]~input_o\) # ((\RAM|s_memory~125_q\)))) # (!\SW[1]~input_o\ & (!\SW[0]~input_o\ & (\RAM|s_memory~109_q\)))
...
-- Equation(s):
-- \RAM|s_memory~245_combout\ = (\SW[2]~input_o\ & (!\SW[1]~input_o\ & (\SW[3]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~251_combout\ = (\SW[2]~input_o\ & (\SW[1]~input_o\ & (\SW[3]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~221_combout\ = (!\SW[2]~input_o\ & (\SW[1]~input_o\ & (\SW[3]~input_o\ & !\SW[0]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~222_combout\ = (\RAM|s_memory~221_combout\ & \SW[12]~input_o\)
...
-- Equation(s):
-- \RAM|s_memory~227_combout\ = (\SW[1]~input_o\ & (\SW[3]~input_o\ & (\SW[0]~input_o\ & !\SW[2]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~227_combout\,
	datad => \SW[12]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~225_combout\ = (!\SW[1]~input_o\ & (\SW[3]~input_o\ & (!\SW[0]~input_o\ & !\SW[2]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~225_combout\,
	datad => \SW[12]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~223_combout\ = (!\SW[2]~input_o\ & (!\SW[1]~input_o\ & (\SW[3]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~141_combout\ = (\SW[0]~input_o\ & (((\RAM|s_memory~85_q\) # (\SW[1]~input_o\)))) # (!\SW[0]~input_o\ & (\RAM|s_memory~77_q\ & ((!\SW[1]~input_o\))))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datab => \RAM|s_memory~77_q\,
	datac => \RAM|s_memory~85_q\,
	datad => \SW[1]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~229_combout\ = (!\SW[1]~input_o\ & (!\SW[3]~input_o\ & (\SW[0]~input_o\ & \SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~230_combout\ = (\RAM|s_memory~229_combout\ & \SW[12]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~229_combout\,
	datad => \SW[12]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~235_combout\ = (\SW[1]~input_o\ & (!\SW[3]~input_o\ & (\SW[0]~input_o\ & \SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~231_combout\ = (\SW[1]~input_o\ & (!\SW[3]~input_o\ & (!\SW[0]~input_o\ & \SW[2]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~231_combout\,
	datad => \SW[12]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~233_combout\ = (!\SW[1]~input_o\ & (!\SW[3]~input_o\ & (!\SW[0]~input_o\ & \SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~234_combout\ = (\RAM|s_memory~233_combout\ & \SW[12]~input_o\)
...
-- Equation(s):
-- \RAM|s_memory~237_combout\ = (\SW[1]~input_o\ & (!\SW[3]~input_o\ & (!\SW[0]~input_o\ & !\SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~241_combout\ = (!\SW[2]~input_o\ & (!\SW[1]~input_o\ & (!\SW[3]~input_o\ & !\SW[0]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~242_combout\ = (\RAM|s_memory~241_combout\ & \SW[12]~input_o\)
...
-- Equation(s):
-- \RAM|s_memory~239_combout\ = (!\SW[2]~input_o\ & (!\SW[1]~input_o\ & (!\SW[3]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~145_combout\ = (\SW[0]~input_o\ & ((\SW[1]~input_o\) # ((\RAM|s_memory~21_q\)))) # (!\SW[0]~input_o\ & (!\SW[1]~input_o\ & (\RAM|s_memory~13_q\)))
...
PORT MAP (
	...
	datad => \RAM|s_memory~21_q\,
	combout => \RAM|s_memory~145_combout\);

-- Location: LCCOMB_X111_Y37_N24
\RAM|s_memory~243\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~243_combout\ = (!\SW[2]~input_o\ & (\SW[1]~input_o\ & (!\SW[3]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~147_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~144_combout\) # ((\SW[3]~input_o\)))) # (!\SW[2]~input_o\ & (((!\SW[3]~input_o\ & \RAM|s_memory~146_combout\))))
...
PORT MAP (
	...
	datac => \SW[3]~input_o\,
	datad => \RAM|s_memory~146_combout\,
...
\RAM|s_memory~102feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~102feeder_combout\ = \SW[5]~input_o\
...
PORT MAP (
	datad => \SW[5]~input_o\,
	combout => \RAM|s_memory~102feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~input_o\,
	d => \RAM|s_memory~102feeder_combout\,
	ena => \RAM|s_memory~228_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \RAM|s_memory~159_combout\ = (\RAM|s_memory~158_combout\ & (((\RAM|s_memory~134_q\)) # (!\SW[3]~input_o\))) # (!\RAM|s_memory~158_combout\ & (\SW[3]~input_o\ & ((\RAM|s_memory~102_q\))))
...
-- Equation(s):
-- \RAM|s_memory~86feeder_combout\ = \SW[5]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~154_combout\ = (\RAM|s_memory~153_combout\ & (((\RAM|s_memory~118_q\)) # (!\SW[3]~input_o\))) # (!\RAM|s_memory~153_combout\ & (\SW[3]~input_o\ & ((\RAM|s_memory~86_q\))))
...
-- Equation(s):
-- \RAM|s_memory~62feeder_combout\ = \SW[5]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~94feeder_combout\ = \SW[5]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~160_combout\ = (\RAM|s_memory~157_combout\ & ((\RAM|s_memory~159_combout\) # ((!\SW[1]~input_o\)))) # (!\RAM|s_memory~157_combout\ & (((\SW[1]~input_o\ & \RAM|s_memory~152_combout\))))
...
PORT MAP (
	...
	datac => \SW[1]~input_o\,
	datad => \RAM|s_memory~152_combout\,
...
-- Equation(s):
-- \RAM|s_memory~165_combout\ = (\SW[0]~input_o\ & (\SW[1]~input_o\)) # (!\SW[0]~input_o\ & ((\SW[1]~input_o\ & ((\RAM|s_memory~31_q\))) # (!\SW[1]~input_o\ & (\RAM|s_memory~15_q\))))
...
-- Equation(s):
-- \RAM|s_memory~79feeder_combout\ = \SW[6]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~167_combout\ = (\SW[3]~input_o\ & (((\SW[2]~input_o\) # (\RAM|s_memory~164_combout\)))) # (!\SW[3]~input_o\ & (\RAM|s_memory~166_combout\ & (!\SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~162_combout\ = (\SW[1]~input_o\ & ((\RAM|s_memory~161_combout\ & ((\RAM|s_memory~71_q\))) # (!\RAM|s_memory~161_combout\ & (\RAM|s_memory~63_q\)))) # (!\SW[1]~input_o\ & (((\RAM|s_memory~161_combout\))))
...
PORT MAP (
	...
	datad => \RAM|s_memory~161_combout\,
...
PORT MAP (
	...
	datad => \RAM|s_memory~162_combout\,
...
-- Equation(s):
-- \RAM|s_memory~56feeder_combout\ = \SW[7]~input_o\
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~174_combout\,
	datab => \RAM|s_memory~176_combout\,
	datac => \SW[1]~input_o\,
	datad => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~72feeder_combout\ = \SW[7]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~178_combout\ = (\SW[2]~input_o\ & (((\SW[3]~input_o\)))) # (!\SW[2]~input_o\ & ((\SW[3]~input_o\ & (\RAM|s_memory~104_q\)) # (!\SW[3]~input_o\ & ((\RAM|s_memory~40_q\)))))
...
\RAM|s_memory~33feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~33feeder_combout\ = \SW[8]~input_o\
...
PORT MAP (
	datad => \SW[8]~input_o\,
	combout => \RAM|s_memory~33feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~input_o\,
	d => \RAM|s_memory~33feeder_combout\,
	ena => \RAM|s_memory~238_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~33_q\);
...
-- Equation(s):
-- \RAM|s_memory~185_combout\ = (\SW[0]~input_o\ & ((\SW[1]~input_o\) # ((\RAM|s_memory~25_q\)))) # (!\SW[0]~input_o\ & (!\SW[1]~input_o\ & (\RAM|s_memory~17_q\)))
...
-- Equation(s):
-- \RAM|s_memory~57feeder_combout\ = \SW[8]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~89feeder_combout\ = \SW[8]~input_o\
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~81_q\,
	datab => \SW[1]~input_o\,
	datac => \RAM|s_memory~89_q\,
	datad => \SW[0]~input_o\,
...
PORT MAP (
	...
	datad => \RAM|s_memory~181_combout\,
...
-- Equation(s):
-- \RAM|s_memory~98feeder_combout\ = \SW[9]~input_o\
...
PORT MAP (
	...
	datac => \RAM|s_memory~191_combout\,
	datad => \SW[2]~input_o\,
...
\RAM|s_memory~42feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~42feeder_combout\ = \SW[9]~input_o\
...
PORT MAP (
	datad => \SW[9]~input_o\,
	combout => \RAM|s_memory~42feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~input_o\,
	d => \RAM|s_memory~42feeder_combout\,
	ena => \RAM|s_memory~244_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~42_q\);
...
-- Equation(s):
-- \RAM|s_memory~83feeder_combout\ = \SW[10]~input_o\
...
\RAM|s_memory~43feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~43feeder_combout\ = \SW[10]~input_o\
...
PORT MAP (
	datad => \SW[10]~input_o\,
	combout => \RAM|s_memory~43feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~input_o\,
	d => \RAM|s_memory~43feeder_combout\,
	ena => \RAM|s_memory~244_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~43_q\);
...
-- Equation(s):
-- \RAM|s_memory~206_combout\ = (\RAM|s_memory~205_combout\ & ((\RAM|s_memory~43_q\) # ((!\SW[0]~input_o\)))) # (!\RAM|s_memory~205_combout\ & (((\SW[0]~input_o\ & \RAM|s_memory~27_q\))))
...
PORT MAP (
	...
	datab => \RAM|s_memory~43_q\,
	datac => \SW[0]~input_o\,
	datad => \RAM|s_memory~27_q\,
...
-- Equation(s):
-- \RAM|s_memory~123feeder_combout\ = \SW[10]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~131feeder_combout\ = \SW[10]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~209_combout\ = (\RAM|s_memory~208_combout\ & ((\RAM|s_memory~139_q\) # ((!\SW[1]~input_o\)))) # (!\RAM|s_memory~208_combout\ & (((\SW[1]~input_o\ & \RAM|s_memory~131_q\))))
...
-- Equation(s):
-- \RAM|s_memory~210_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~207_combout\ & (\RAM|s_memory~209_combout\)) # (!\RAM|s_memory~207_combout\ & ((\RAM|s_memory~202_combout\))))) # (!\SW[2]~input_o\ & (\RAM|s_memory~207_combout\))
...
PORT MAP (
	...
	datac => \RAM|s_memory~209_combout\,
...
-- Equation(s):
-- \RAM|s_memory~211_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~92_q\) # ((\SW[2]~input_o\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~28_q\ & !\SW[2]~input_o\))))
...
\RAM|s_memory~140feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~140feeder_combout\ = \SW[11]~input_o\
...
PORT MAP (
	datad => \SW[11]~input_o\,
	combout => \RAM|s_memory~140feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~input_o\,
	d => \RAM|s_memory~140feeder_combout\,
	ena => \RAM|s_memory~252_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \RAM|s_memory~108feeder_combout\ = \SW[11]~input_o\
...
PORT MAP (
	dataa => \SW[2]~input_o\,
	datab => \RAM|s_memory~108_q\,
	datac => \SW[3]~input_o\,
	datad => \RAM|s_memory~44_q\,
...
-- Equation(s):
-- \RAM|s_memory~219_combout\ = (\RAM|s_memory~218_combout\ & ((\RAM|s_memory~140_q\) # ((!\SW[2]~input_o\)))) # (!\RAM|s_memory~218_combout\ & (((\SW[2]~input_o\ & \RAM|s_memory~76_q\))))
...
-- Equation(s):
-- \RAM|s_memory~100feeder_combout\ = \SW[11]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~132feeder_combout\ = \SW[11]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~52feeder_combout\ = \SW[11]~input_o\
...
\RAM|s_memory~116feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~116feeder_combout\ = \SW[11]~input_o\
...
PORT MAP (
	datad => \SW[11]~input_o\,
	combout => \RAM|s_memory~116feeder_combout\);
...
PORT MAP (
	clk => \ALT_INV_KEY[0]~input_o\,
	d => \RAM|s_memory~116feeder_combout\,
	ena => \RAM|s_memory~250_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
